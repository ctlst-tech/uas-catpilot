...
mag = EwChart([DataSourceEswbTopic('mag_x', path=f'{topics_root}/nav/nav/mag/x'),
                        DataSourceEswbTopic('mag_y', path=f'{topics_root}/nav/nav/mag/y'),
                        DataSourceEswbTopic('mag_z', path=f'{topics_root}/nav/nav/mag/z')],
                        data_range=(-0.7, +0.7))
...
mon.add_widget(EwGroup([ai, hi, imu_roll_pitch, ]))
